...
class PoseNet(nn.Module):
    ...
    def __init__(self, in_channel, out_channel=7, aux_logits=True, transform_input=False, init_weights=None,
                 blocks=None):
...
def test():
    net = PoseNet(in_channel=2,init_weights=True,aux_logits=True)
    x = torch.randn(4,2,72,254)
    y = net(x)
    print(y[0].shape)
    print(y[1])
    print(y[2])
